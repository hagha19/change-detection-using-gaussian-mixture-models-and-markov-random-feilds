function i=fwritehdr(image,fname);

% fwritehdr - write BSQ image with ENVI-like hdr from MATLAB array
%               (V. Guissard, Apr 29 2004)
%
...
% Modified (very moderately) by Allan Aasbjerg Nielsen, aa@imm.dtu.dk, Mar 2005
